...
| LCU / PREPARE-SELECT | [[LCU Origins (Childs-Wiebe 2012) — Paper Notes]], [[Time-Dependent Hamiltonian Simulation via Dyson Series (Kieferová-Scherer-Berry 2018) — Paper Notes]], [[Dyson Series Simulation in the Interaction Picture (Low-Wiebe 2018) — Paper Notes]], [[SOSSA — Sum-of-Squares Spectral Amplification]] |

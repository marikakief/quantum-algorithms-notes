...
$$
an improvement over prior single product-formula bounds (which had exponent constant ≈2.06 or ≈2.54) in the Hamiltonian-decomposition model with $m$ terms of norm at most $h$. The exponent is subexponential in the precision parameter -- better than the older single-sequence Suzuki bounds in this comparison, but not the polylog$(1/\epsilon)$ scaling that later Taylor/QSP methods achieve. The sign problem (negative LCU coefficients) is the obstacle.
...
- [[Simulating Hamiltonian Dynamics with a Truncated Taylor Series (Berry-Childs-Cleve-Kothari-Somma 2015) — Paper Notes]] — refined PREPARE/SELECT formulation of LCU; near-optimal simulation via truncated Taylor series
...
- [[Quantum Amplitude Amplification and Estimation (Brassard-Høyer-Mosca-Tapp 2002) — Paper Notes|Brassard, Høyer, Mosca & Tapp (2002)]] — amplitude amplification background

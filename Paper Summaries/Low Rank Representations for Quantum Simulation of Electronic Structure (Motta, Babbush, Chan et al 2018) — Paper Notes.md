...
4. **Only first-order Trotter.** Higher-order Trotter-Suzuki formulas would reduce the number of steps but increase the per-step cost. The interplay between double factorization and higher-order product formulas isn't explored.

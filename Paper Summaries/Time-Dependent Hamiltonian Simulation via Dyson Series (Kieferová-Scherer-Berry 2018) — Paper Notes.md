...
- [[Randomizing Multi-Product Formulas for Hamiltonian Simulation (Faehrmann-Steudtner-Kueng-Kieferová-Eisert 2022) — Paper Notes]] — Marika's later [[Hamiltonian simulation]] paper; pursues randomized multi-[[Product Formulas]]s as an alternative to the Dyson-LCU approach developed here

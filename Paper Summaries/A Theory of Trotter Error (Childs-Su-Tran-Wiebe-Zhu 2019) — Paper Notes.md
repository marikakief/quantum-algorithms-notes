...
- [[Selection and Improvement of Product Formulae for Best Performance of Quantum Simulation (Morales-Costa-Pantaleoni-Burgarth-Sanders-Berry 2025) — Paper Notes]] — finds 8th-order product formulas ~100× more accurate than prior work; uses eigenvalue error rather than spectral-norm error as the relevant metric; the tight commutator bounds from this paper motivate the constant-factor optimization

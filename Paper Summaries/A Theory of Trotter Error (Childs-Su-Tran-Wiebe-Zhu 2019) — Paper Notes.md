...
For a $p$-th order [[Product Formulas]], define
$$
...
For local or nearly-commuting Hamiltonians at moderate precision, [[Product Formulas]]s can be much better than block-encoding-based bounds suggest. For high precision or adversarial structure, qubitization/QSP still wins asymptotically.
...
- [[Hamiltonian Simulation by Qubitization (Low-Chuang 2019) — Paper Notes|Low & Chuang (2019)]] — qubitization/QSP as the asymptotic competitor to [[Product Formulas]]s
...
- [[qDRIFT Randomized Hamiltonian Simulation (Campbell 2018) — Paper Notes|Campbell (2019)]] — randomized alternative to deterministic [[Product Formulas]]s

---

## Cross-links

- [[Nearly Optimal Lattice Simulation by Product Formulas (Childs-Su 2019) — Paper Notes]] — specialises the general commutator/error-representation machinery to 1D lattice geometry and gets the sharp linear-in-$n$ bound
...
- [[Selection and Improvement of Product Formulae for Best Performance of Quantum Simulation (Morales-Costa-Pantaleoni-Burgarth-Sanders-Berry 2025) — Paper Notes]] — finds 8th-order [[Product Formulas]]s ~100× more accurate than prior work; uses eigenvalue error rather than spectral-norm error as the relevant metric; the tight commutator bounds from this paper motivate the constant-factor optimization
- [[Randomizing Multi-Product Formulas for Hamiltonian Simulation (Faehrmann-Steudtner-Kueng-Kieferová-Eisert 2022) — Paper Notes]] — multi-[[Product Formulas]] approach; relies on the Trotter error structure this paper analyses to bound the MPF approximation error
...
- [[Nearly Tight Trotterization of Interacting Electrons (Su-Huang-Campbell 2021) — Paper Notes]] — specialises this paper's commutator-scaling framework to fermionic Hamiltonians; introduces the fermionic seminorm to restrict error analysis to the $\eta$-electron manifold; nearly tight bounds for plane-wave electronic structure and Fermi-Hubbard

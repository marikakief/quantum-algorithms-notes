...
A [[product formula]] (Trotter–Suzuki formula) approximates the time evolution $e^{-iHt}$ for $H = \sum_j H_j$ by composing the individual evolutions $e^{-iH_j t}$:
